# ==============================================================================
# SSU_25_NLP_project - nlu/nlu_utils.py
#
# [개요]
# NLU 모델 훈련(train_intent.py, train_slot.py)에 필요한 학습 데이터(.jsonl 파일)를
# 안정적으로 로드하기 위한 범용 유틸리티 함수를 제공합니다.
#
# [주요 역할]
# 1. JSONL 로드: load_jsonl() 함수를 통해 각 라인이 JSON 객체인 파일을 읽어 리스트로 변환합니다.
# 2. 오류 방어: 파일 존재 유무, JSON 디코딩 오류 등을 확인하여 훈련 프로세스의 안정성을 확보합니다.
#
# [사용처]
# - train_intent.py, train_slot.py (NLU 훈련 스크립트)
# ==============================================================================
# 작업자 : 박대정 
